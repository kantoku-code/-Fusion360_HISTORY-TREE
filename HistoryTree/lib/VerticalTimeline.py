...
# 'C:\\Users\\nori\\OneDrive\\fusion360API\\Addin\\Fusion360_HISTORY-TREE\\HistryTree\\lib'
...
def get_image_path(subpath):
    ...
    path = f'{get_fusion_deploy_folder()}/{subpath}/16x16.png'
...
BODY_RESOURCE_MAP = {
    SOLID_BODY: ('/Neutron/UI/Base/Resources/Browser/SolidBody'),
    SURFACE_BODY: ('/Neutron/UI/Base/Resources/Browser/SolidBody'),
    MESH_BODY: ('/Neutron/UI/Base/Resources/Browser/SolidBody'),
    SHEETMETAL_BODY: ('/Neutron/UI/Base/Resources/Browser/SolidBody'),
}

def get_body_image(body):
    bBody: adsk.fusion.BRepBody = adsk.fusion.BRepBody.cast(body)
    resource_folder = get_fusion_deploy_folder()
    if not bBody:
        return resource_folder + BODY_RESOURCE_MAP[MESH_BODY] + '/16x16.png'
    elif bBody.isSheetMetal:
        return resource_folder + BODY_RESOURCE_MAP[SHEETMETAL_BODY] + '/16x16.png'
    elif bBody.isSolid:
        return resource_folder + BODY_RESOURCE_MAP[SOLID_BODY] + '/16x16.png'
    else:
        return resource_folder + BODY_RESOURCE_MAP[SURFACE_BODY] + '/16x16.png'